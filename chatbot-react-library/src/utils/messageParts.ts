...
/** Image part or file part with an image MIME type. */
export function isImageLikePart(
  part: MessagePart,
): part is ImagePart | FilePart {
...
export function imagePartDataUrl(part: ImagePart | FilePart): string {
  const mime =
    part.type === "image" ? part.mimeType : part.mimeType || "image/jpeg";
